...
namespace AIMS.Libraries.Scripting.NRefactory.Parser.VB
{
	public static class Tokens
	{
		...
		public static BitArray Null = Tokens.NewSet(new int[]
		{
			130
		});

		public static BitArray BlockSucc = Tokens.NewSet(new int[]
		{
			57,
			58,
			86,
		...
		public static BitArray Unreserved = Tokens.NewSet(new int[]
		{
			169,
			51,
			70,
		...
		{
			BitArray bitArray = new BitArray(205);
