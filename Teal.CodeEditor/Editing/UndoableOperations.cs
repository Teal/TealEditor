...
namespace Teal.CodeEditor {
    ...
    public abstract class UndoableOperation {
        ...
        private int _oldLine, _oldColumn;
        ...
        /// 判断当前操作是否可以和指定操作同时执行。
        /// </summary>
        /// <param name="editor">要撤销的编辑器。</param>
        /// <param name="op">要判断的操作。</param>
        /// <returns>如果可以同时执行则返回 true，否则返回 false。</returns>
        public virtual bool canTrain(CodeEditor editor, UndoableOperation op) {
            return false;
        }
        ...
        /// </summary>
        /// <param name="editor">要撤销的编辑器。</param>
        public abstract void undo(CodeEditor editor);

        /// <summary>
        /// 对指定编辑器执行当前的恢复操作。
        /// </summary>
        /// <param name="editor">要恢复的编辑器。</param>
        public abstract void redo(CodeEditor editor);
    ...
    sealed class BackCharOperation : CharOperation {
        ...
        /// </summary>
        /// <param name="editor">要撤销的编辑器。</param>
        public override void undo(CodeEditor editor) {
        ...
        /// </summary>
        /// <param name="editor">要恢复的编辑器。</param>
        public override void redo(CodeEditor editor) {
    ...
    sealed class InsertCharOperation : CharOperation {
        ...
        /// <param name="op">要判断的操作。</param>
        /// <returns>如果可以同时执行则返回 true，否则返回 false。</returns>
        public override bool canTrain(CodeEditor editor, UndoableOperation op) {
        ...
        /// <param name="editor">要撤销的编辑器。</param>
        public override void undo(CodeEditor editor) {
            editor.document.delete(newLine, newColumn);
        }
        ...
        /// <param name="editor">要恢复的编辑器。</param>
        public override void redo(CodeEditor editor) {
            editor.document.insert(oldLine, oldColumn, value);
        }
