...
namespace Teal.CodeEditor {
    ...
    public partial class CodeEditor {
        ...
        public void insert(int caretLine, int caretColumn, string value) {
            var newEnd = document.insert(caretLine, caretColumn, value);
            addUndo(new InsertBlockOperation(caretLine, caretColumn, newEnd.Y, newEnd.X, value));
